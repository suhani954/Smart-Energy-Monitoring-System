...
//         Math.abs(delta) < 2 ? "Battery efficiency stable." : "Noticeable change detected — monitor load.";
//       const comparisonMessage =
//         predicted < actual ? "Predicted to discharge slightly." : "Predicted to remain stable or increase.";
...
//       const solarContribution = batteryData.solar_contribution_percent ?? null;
...
//   solarContribution: batteryData.solar_contribution_percent ?? null,
// });
...
//             <p className="text-sm text-indigo-200 mt-1">Real-time battery & system consumer insights — auto-refresh every 10s</p>
//           </div>
//           <div className="text-sm text-indigo-200">
//             Last updated: <span className="font-medium text-white">{formatTime(lastUpdated)}</span>
//           </div>
//         </div>

//         {/* Battery Card + Chart */}
//         <div className="battery-card-container bg-gradient-to-br from-white/10 via-white/10 to-white/6 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-6">
//           <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
//             {/* Left: Content */}
//             <div className="flex-1">
//               <h2 className="text-xl text-white font-semibold mb-2">Battery Insights</h2>
//               <p className="text-sm text-indigo-200 mb-4">Live actual and predicted battery values synced with the chart.</p>

//               <div className="flex flex-wrap gap-3 mb-4">
//                 <div className="px-3 py-2 bg-white/5 rounded-lg">
//                   <p className="text-xs text-indigo-200">Actual</p>
//                   <p className="text-lg font-bold">{batteryLife ?? "--"}%</p>
//                 </div>
//                 <div className="px-3 py-2 bg-white/5 rounded-lg">
//                   <p className="text-xs text-indigo-200">Predicted</p>
//                   <p className="text-lg font-bold">{predictedBattery ?? "--"}%</p>
//                 </div>
//                 <div className="px-3 py-2 bg-white/5 rounded-lg">
//                   <p className="text-xs text-indigo-200">Health</p>
//                   <p className="text-lg font-bold">{batteryStats.batteryHealth}</p>
//                 </div>
//               </div>
...
//                   <p className="text-sm font-medium text-white">{batteryStats.statusMessage}</p>
//                 </div>
//                 <div className="p-3 bg-white/5 rounded-lg">
//                   <p className="text-xs text-indigo-200">Efficiency</p>
//                   <p className="text-sm font-medium text-white">{batteryStats.efficiencyMessage}</p>
//                 </div>
//                 <div className="p-3 bg-white/5 rounded-lg">
//                   <p className="text-xs text-indigo-200">Comparison</p>
//                   <p className="text-sm font-medium text-white">{batteryStats.comparisonMessage}</p>
//                 </div>
//               </div>

//               <div className="p-3 bg-white/5 rounded-lg mb-5">
//                 <p className="text-sm text-indigo-200 font-semibold mb-2">Recommendations</p>
//                 <ul className="list-disc ml-5 text-sm text-indigo-100 space-y-1">
//                   {batteryStats.recommendations?.map((r, idx) => <li key={idx}>{r}</li>)}
//                 </ul>
//               </div>
//             </div>

//             {/* Right: Battery Circle */}
//             <div className="w-36 flex-shrink-0 flex flex-col items-center justify-center mt-4 lg:mt-0">
//               <div className="w-28 h-28 rounded-full flex items-center justify-center bg-gradient-to-tr from-indigo-700 to-violet-600 p-1 shadow-inner transform transition-transform duration-500">
//                 <div className="w-full h-full rounded-full bg-gradient-to-b from-white/10 to-white/6 flex flex-col items-center justify-center">
//                   <div className="text-sm text-indigo-200">Battery</div>
//                   <div className="text-2xl font-extrabold text-white">{batteryLife ?? "--"}%</div>
//                   <div className="text-xs text-indigo-200 mt-1">Pred: {predictedBattery ?? "--"}%</div>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           {/* Chart */}
//           {/* <div className="mt-6 bg-white/4 p-4 rounded-xl shadow-inner"> */}
//             <BatteryChart 
...
//         {/* High Consumers */}
//         <div className="high-consumer-report bg-white/5 rounded-2xl shadow-md p-5">
//           <div className="flex items-center justify-between mb-4">
//             <h3 className="text-lg font-semibold text-white">High Consumers</h3>
//             <div>
//               <label className="text-xs text-indigo-200 mr-2">Show Top</label>
//               <select value={topN} onChange={e => setTopN(Number(e.target.value))}
//                 className="bg-white/10 text-black px-2 py-1 rounded transition-colors">
...
//             <div className="p-3 bg-white/5 rounded-lg">
//               <p className="text-xs text-indigo-200">Avg CPU</p>
//               <p className="text-lg font-bold text-white">{avgCPU}%</p>
//             </div>
//             <div className="p-3 bg-white/5 rounded-lg">
//               <p className="text-xs text-indigo-200">Avg Memory</p>
//               <p className="text-lg font-bold text-white">{avgMemory}%</p>
//             </div>
//           </div>

//           {/* Top CPU/Memory Cards */}
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
//             <div>
//               <h4 className="text-sm text-indigo-200 font-semibold mb-2">Top {topN} CPU</h4>
//               <div className="flex flex-col gap-2">
//                 {topCPU.map((c,i) => (
//                   <div key={i} className="bg-white/5 rounded-lg p-2 flex justify-between text-white text-sm">
//                     <span>{c.name}</span>
...
//             </div>
//             <div>
//               <h4 className="text-sm text-indigo-200 font-semibold mb-2">Top {topN} Memory</h4>
//               <div className="flex flex-col gap-2">
//                 {topMemory.map((c,i) => (
//                   <div key={i} className="bg-white/5 rounded-lg p-2 flex justify-between text-white text-sm">
//                     <span>{c.name}</span>
//                     <span>{c.memory_percent ?? 0}%</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//           {warnings.length > 0 && (
//             <div className="mb-3 p-3 bg-red-600/10 rounded-lg">
//               <p className="text-sm text-red-200 font-semibold">⚠ Warnings</p>
//               {warnings.map((w,i) => <p key={i} className="text-xs text-red-100">{w.name} — CPU: {w.cpu_percent ?? 0}%, Mem: {w.memory_percent ?? 0}%</p>)}
//             </div>
//           )}

//           {tips.length > 0 && (
//             <div className="mb-3 p-3 bg-green-600/20 rounded-lg">
//               <p className="text-sm text-green-200 font-semibold">💡 Tips</p>
//               {tips.map((t,i) => <p key={i} className="text-xs text-green-100">{t}</p>)}
//             </div>
//           )}
...
//             className="bg-white text-indigo-800 px-6 py-2 rounded-full font-semibold shadow-lg hover:scale-105 transition-transform duration-200">
